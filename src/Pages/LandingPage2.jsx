...
function Band({ maxSpeed = 50, minSpeed = 10 }) {
  ...
  const { nodes, materials } = useGLTF('/assets/lanyard.glb')
  const texture = useTexture('/assets/lanyard_band.jpg')
...
export default function LandingPage2() {
  return (
    <>
      ...
      <section id="about" className="min-h-screen bg-zinc-900 text-white px-8 py-16 flex items-center justify-center">
      ...
      <section id="work" className="min-h-screen bg-zinc-800 text-white px-8 py-16">
        <h2 className="text-5xl text-center">Work Section</h2>
      </section>

      <section id="contact" className="min-h-screen bg-zinc-700 text-white px-8 py-16">
        <h2 className="text-5xl text-center">Contact Section</h2>
      </section>
    </>
  )
}
